...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x934823cD49F92e78B9560BC8d71B356FD9CD6104), // RentGenesisPool
        address(0x08CEb793c1aa085D9Bd7e9fcE3FC789AEE3652ce) // new RentRewardPool
    ...
    function setExtraFunds(
        ...
        uint256 _housingFundSharedPercent
        ...
        require(_teamFundSharedPercent <= 300, "out of range"); // <= 3%
        require(_housingFund != address(0), "zero");
        require(_housingFundSharedPercent <= 3000, "out of range"); // <= 30%
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            _sendToBoardroom(rentSupply.mul(bootstrapSupplyExpansionPercent).div(10000));
        } else {
            if (previousEpochRentPrice > rentPriceCeiling) {
                ...
                if (seigniorageSaved >= bondSupply.mul(bondDepletionFloorPercent).div(10000)) {
                    ...
                    _savedForBoardroom = rentSupply.mul(_percentage).div(1e18);
                } else {
