...
contract RShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _housingFund, address _teamFund) public ERC20("RSHARE", "RSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 RENT Share for initial pools deployment
        ...
        housingFundRewardRate = HOUSING_FUND_POOL_ALLOCATION.div(VESTING_DURATION); //<--- Maybe this can be Instant. Maybe 1 month.
