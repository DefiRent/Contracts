...
contract Rent is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 9000  ether; //<---9000 Orginal 
    // Distribution for housing fund wallet
    uint256 public constant INITIAL_HOUSING_WALLET_DISTRIBUTION = 10000 ether;//<---10000 Orginal 
    // Distribution for team fund wallet
    uint256 public constant INITIAL_TEAM_WALLET_DISTRIBUTION = 6000 ether;
    // Distribution for team fund wallet
    uint256 public constant INITIAL_DEV_WALLET_DISTRIBUTION = 5000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("RENT", "RENT") {
